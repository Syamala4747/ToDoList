...
const Home = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.get('https://todolist-server-jso4.onrender.com/tasks');
  ...
  const addTask = async () => {
    try {
      const response = await axios.post('https://todolist-server-jso4.onrender.com/tasks', newTask);
  ...
  const deleteTask = async (id) => {
    try {
      await axios.delete(`https://todolist-server-jso4.onrender.com/tasks/${id}`);
  ...
  const updateTask = async (id) => {
    try {
      const response = await axios.put(`https://todolist-server-jso4.onrender.com/tasks/${id}`, editingTask);
